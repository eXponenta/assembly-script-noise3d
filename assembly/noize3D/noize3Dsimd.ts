...
@inline export function generateSimd(xStart: f32, y: f32, z: f32, xStep: f64, xSize: u32, resultArray: Float32Array, resultOffset: u32): u32 {
    for (let ind: u32 = 0; ind < xSize; ind++) {
        const x: f32 = f32(xStart + xStep * f64(ind));
